    ...
    <div className="bg-gray-50">
      ...
      <header className="relative bg-gradient-to-b from-blue-200 to-blue-50 text-white py-40 flex flex-col items-center text-center px-4">
        ...
        <button 
          ...
          className="mt-6 bg-blue-500 text-gray-100 font-bold py-3 px-10 rounded-full shadow-lg text-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105 hover:shadow-2xl"
        >
      ...
      {/* About Section */}
      <section id="about" className="py-24 text-center bg-gradient-to-t from-gray-100 to-blue-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-gray-800">{t("planAdventure")}</h2>
      ...
      {/* Features Section */}
      <section id="features" className="py-24 bg-gradient-to-b from-gray-100 via-gray-50 to-blue-50">
        <div className="container mx-auto text-center px-6">
          <h2 className="text-4xl font-bold text-gray-800 mb-12">{t("features")}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* Feature Card */}
            <div className="p-8 bg-white/60 backdrop-blur-md rounded-3xl shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
              {/* <FaClipboardList className="text-gray-500 text-6xl mx-auto mb-4" /> */}
              <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 76.5625 71.2402"
              className="w-12 h-12 m-5 inline-block mr-2"
            >
              <g>
              ...
              <h3 className="text-2xl font-semibold text-gray-700">{t("itineraryPlan")}</h3>
              <p className="text-gray-600 mt-2">{t("itineraryPlanDes")}</p>
            </div>
            <div className="p-8 bg-white/60 backdrop-blur-md rounded-3xl shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
              {/* <FaDollarSign className="text-gray-500 text-6xl mx-auto mb-4" /> */}
              <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            >
              ...
              <h3 className="text-2xl font-semibold text-gray-700">{t("expenseTrack")}</h3>
              <p className="text-gray-600 mt-2">{t("expenseTrackDes")}</p>
            </div>
            <div className="p-8 bg-white/60 backdrop-blur-md rounded-3xl shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
              {/* <FaMapMarkedAlt className="text-gray-500 text-6xl mx-auto mb-4" /> */}
              <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            >
              ...
              <h3 className="text-2xl font-semibold text-gray-700">{t("map")}</h3>
              <p className="text-gray-600 mt-2">{t("mapDes")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Call to Action */}
      <section className="py-24 bg-gradient-to-t from-blue-100 to-blue-50 text-white text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-blue-500">{t("startAdventure")}</h2>
          <p className="text-lg mt-4 max-w-2xl mx-auto text-blue-500">{t("ctaDes")}</p>
          <button 
            onClick={handleLoginClick} 
            className="mt-6 bg-blue-500 text-gray-100 font-bold py-3 px-10 rounded-full shadow-lg text-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105 hover:shadow-2xl"
          >
